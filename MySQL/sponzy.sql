...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-03-2021 a las 07:52:03
...
CREATE TABLE `users` (
  ...
  `notify_email_new_post` enum('yes','no') NOT NULL DEFAULT 'no',
