...
class HomeController extends Controller
{
  ...
  public function __construct(Request $request, AdminSettings $settings) {
    ...
    public function index()
    {
      try {
        ...
        if (Auth::guest()) {
          ...
          return view('index.home-session', ['users' => $users, 'updates' => $updates , 'banner'=>$banner]);
    ...
    public function ajaxUserUpdates()
    {
      ...
      return view('includes.updates', ['updates' => $data, 'ajaxRequest' => true, 'counterPosts' => $counterPosts, 'total' => $total , 'banner'=>$banner])->render();
    }//<--- End Method
    ...
    public function creators($type = false)
    {
      ...
      if ($query != '' && strlen($query) >= 3) {
        ...
        return view('index.creators', ['users' => $users, 'title' => $title,'banner'=>$banner]);
    }
