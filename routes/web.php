...
// Paypal IPN (PPV)
Route::post('paypal/ppe/ipn', 'PayPerEventController@paypalPPEIpn');
...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('settings/obs_streaming', 'UserController@obs_streaming');
    ...
    // Pay Per Views
    Route::post('send/ppe', 'PayPerEventController@send');

    // Event
  //  Route::get('events/{event_id}', 'UserController@individual_events');
    
    // Individual Event
    Route::get('individual_event/{event_id}', 'UserController@individual_events');
...
Route::group(['middleware' => 'private.content'], function () {
    ...
    Route::post('sendLiveMessageProfile', 'UserController@sendLiveMessageProfile')->name('sendLiveMessageProfile');

    Route::post('checkCohost', 'UserController@checkCohost')->name('checkCohost');

    Route::post('commentStatus', 'UserController@commentStatus')->name('commentStatus');
    Route::post('checkComment', 'UserController@checkComment')->name('checkComment');
    Route::post('screenSharing', 'UserController@screenSharing')->name('screenSharing');
    Route::post('checkScreenShare', 'UserController@checkScreenShare')->name('checkScreenShare');
    ...
    //Edit Events
    Route::get('showevent/{id}','UserController@showevents');
    Route::put('editevents','UserController@UpdateEvents');

   

    //Users Individual Events change by saifali
    Route::get('/events_edit/{id}','UserController@edit_userindividual')->name('events.geteventByid');

    //delete events
    Route::delete('deleteEvent','UserController@deleteevent');
    ...
    // Individual Event
    Route::get('events/{event_id}', 'UserController@individual_events')->name('individualEvent');

    // my event
    Route::get('my_events', 'UserController@my_events')->name('my_events');

    //start live event
    Route::get('eventLiveStreaming/{id}', 'UserController@eventLiveStreaming')->name('eventLiveStreaming');
    Route::post('startEventStreaming', 'UserController@startEventStreaming')->name('startEventStreaming');
...
Route::group(['middleware' => 'role'], function () {
    ...
    Route::post('panel/admin/billing', 'AdminController@billingStore');
     ...
     // DATABASE SETTING CHANGE BY SAIFALI
     Route::view('panel/admin/settings/database', 'admin.database-settings');
     Route::post('panel/admin/settings/database', 'AdminController@databasesettings');

    // EMAIL SETTINGS
    //Route::view('panel/admin/settings/email', 'admin.email-settings');
	 Route::get('panel/admin/settings/email','AdminController@show_emailSettings');
    ...
    //  Banner Images
    //show 
    Route::get('panel/admin/banner_images','AdminController@banner_images');
    Route::get('panel/admin/home_cropimg/{id}','AdminController@home_ads_Image');


    // edit image show
    Route::get('panel/admin/bannet_edit/{id}','AdminController@edit_image_banner');

    //edit banner image insert
    Route::put('panel/admin/edit_banner','AdminController@banner_crop_edit');
    
    //banner stuatus
    Route::get('panel/admin/ad_status/{id}','AdminController@ad_status_banner');

    
    //USERS ALL EVENTS CHANGE BY SAIFALI
    Route::get('panel/admin/users_events','AdminController@users_events');
    
    //UPDATE EVENT USER
    Route::get('panel/admin/edit_events/{id}','AdminController@edit_user_Event');
    Route::post('panel/admin/update_event','AdminController@Update_user_event')->name('update_event');
    
    //delete event
    Route::delete('panel/admin/delete_event','AdminController@delete_user_Event');
    ...
    // Event image upload
    Route::view('panel/admin/eventImgSetting', 'admin.eventImgSetting');
    Route::post('panel/admin/defaultEventImgUpload', 'AdminController@defaultEventImgUpload');
});
//==== End Panel Admin
// Installer Script
