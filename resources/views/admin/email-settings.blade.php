                 ...
                 <!-- Start Box Body -->
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" value="{{$show['email_no_reply']}}" name="MAIL_FROM_ADDRESS" class="form-control" placeholder="no-reply@example.com">
                      </div>
                    </div>
                  </div><!-- /.box-body -->
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <select name="MAIL_MAILER" id="emailDriver" class="form-control custom-select">
                            <option @if ($show['mail_mailer'] == 'sendmail') selected @endif value="sendmail">Sendmail</option>
                            <option @if ($show['mail_mailer'] == 'smtp') selected @endif value="smtp">SMTP</option>
                            <option @if ($show['mail_mailer'] == 'mailgun') selected @endif value="mailgun">Mailgun</option>
                            <option @if ($show['mail_mailer'] == 'ses') selected @endif value="ses">Amazon Simple Email Service (SES)</option>
                            <option @if ($show['mail_mailer'] == 'postmark') selected @endif value="postmark">Postmark</option>
                          </select>
                    ...
                    <!-- Start Box Body -->
                     <div class="box-body">
                       <div class="form-group">
                         ...
                         <div class="col-sm-10">
                           <input type="text" value="{{$show['host']}}" name="MAIL_HOST" class="form-control" placeholder="smtp.mailtrap.io">
                         </div>
                       </div>
                     </div><!-- /.box-body -->
                     ...
                     <!-- Start Box Body -->
                      <div class="box-body">
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                            <input type="text" value="{{$show['mail_port']}}" name="MAIL_PORT" class="form-control" placeholder="2525">
                          </div>
                        </div>
                      </div><!-- /.box-body -->
                      ...
                      <!-- Start Box Body -->
                       <div class="box-body">
                         <div class="form-group">
                           ...
                           <div class="col-sm-10">
                             <input type="text" value="{{$show['username']}}" name="MAIL_USERNAME" class="form-control" placeholder="{{trans('admin.mail_username')}}">
                           </div>
                         </div>
                       </div><!-- /.box-body -->
                       ...
                       <!-- Start Box Body -->
                        <div class="box-body">
                          <div class="form-group">
                            ...
                            <div class="col-sm-10">
                              <input type="password" value="{{ $show['password']}}" name="MAIL_PASSWORD" class="form-control" placeholder="{{trans('admin.mail_password')}}">
                            </div>
                          </div>
                        </div><!-- /.box-body -->
                           ...
                           <div class="form-group">
                             ...
                             <div class="col-sm-10">
                               <select name="MAIL_ENCRYPTION" class="form-control custom-select">
                                 <option @if ($show['encrypt'] == '') selected @endif value="">{{trans('general.none')}}</option>
                                 <option @if ($show['encrypt'] == 'tls') selected @endif value="tls">TLS</option>
                                 <option @if ($show['encrypt'] == 'ssl') selected @endif value="ssl">SSL</option>
                               </select>
                             </div>
                           </div>
                         </div><!-- /.box-body -->
