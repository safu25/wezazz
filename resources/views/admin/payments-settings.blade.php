      ...
      <div class="content-wrapper">
		...
		@endif
        	...
        	<div class="box">
              ...
              <div class="box-body">
                <div class="form-group">
                  <label class="col-sm-2 control-label">{{ trans('users.payout_method') }} (FCIB 1st Pay)</label>
                  <div class="col-sm-10">
                    <select name="payout_method_fcib_pay" class="form-control">
                        <option @if( $settings->payout_method_fcib_pay == 'on' ) selected="selected" @endif value="on">{{ trans('general.enabled') }}</option>
                          <option @if( $settings->payout_method_fcib_pay == 'off' ) selected="selected" @endif value="off">{{ trans('general.disabled') }}</option>
                        </select>
                        <p class="help-block">{{ trans('general.payout_method_desc') }}</p>
                  </div>
                </div>
              ...
              <div class="box-body">
                <div class="form-group">
                  <label class="col-sm-2 control-label">{{ trans('users.payout_method') }} ({{ trans('general.bank_wire') }})</label>
                  <div class="col-sm-10">
                    <select name="payout_method_bank_wire" class="form-control">
                        <option @if( $settings->payout_method_bank_wire == 'on' ) selected="selected" @endif value="on">{{ trans('general.enabled') }}</option>
                          <option @if( $settings->payout_method_bank_wire == 'off' ) selected="selected" @endif value="off">{{ trans('general.disabled') }}</option>
                        </select>
                        <p class="help-block">{{ trans('general.payout_method_desc') }}</p>
                  </div>
                </div>
              ...
              <div class="box-body">
                <div class="form-group">
                  <label class="col-sm-2 control-label">{{ trans('users.payout_method') }} ({{ trans('general.wise_payment') }})</label>
                  <div class="col-sm-10">
                    <select name="payout_method_wise_payment" class="form-control">
                        <option @if( $settings->payout_method_wise_payment == 'on' ) selected="selected" @endif value="on">{{ trans('general.enabled') }}</option>
                          <option @if( $settings->payout_method_wise_payment == 'off' ) selected="selected" @endif value="off">{{ trans('general.disabled') }}</option>
                        </select>
                        <p class="help-block">{{ trans('general.payout_method_desc') }}</p>
                  </div>
                </div>
