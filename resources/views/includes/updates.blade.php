...
@if($k % 2 == 0 && $k != 0)
			...
			@if ($ban->status == '1')
             ...
             <img src="{{asset('public/uploads/banner')}}/{{$ban->image}}" alt="nn" width="100%"  height="215px"/>
...
@endif
	...
	<div class="btn-block">
		...
		@if($response->image != '')
			...
			<img src="{{$urlImg}}" data-src="{{$urlImg}}" class="img-fluid lazyload d-inline-block w-100" alt="{{ e($response->description) }}" style="height: 300px;">
