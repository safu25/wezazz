    ...
    <div class="navbar-collapse collapse d-lg-block" id="navbarUserHome">
        <div class="card shadow-sm card-settings">
            <div class="list-group list-group-sm list-group-flush">
                ...
                <a href="{{url('settings/obs_streaming')}}" class="list-group-item list-group-item-action d-flex justify-content-between @if(request()->is('settings/obs_streaming')) active @endif">
                    <div>
                        <i class="feather icon-info icon-navbar mr-2"></i>
                        <span>{{trans('general.obs_stream')}}</span>
                    </div>
                    <div>
                        <i class="feather icon-chevron-right"></i>
                    </div>
