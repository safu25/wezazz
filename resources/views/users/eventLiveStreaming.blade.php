...
<!--                        <input id="countUser" name="countUser" type="text" value="0" >-->
                        ...
                        <div class="form-group">
                                ...
                                <input class="m-0" type="hidden" name="usrAvatar" id="usrAvatar" value="{{ Helper::getFile(config('path.avatar').auth()->user()->avatar) }}">
                    ...
                    <ul id="menu" class="mfb-component--br mfb-zoomin" data-mfb-toggle="hover">
                      <li class="mfb-component__wrap">
                        ...
                        <ul class="mfb-component__list">
                            ...
                            <li class="mfb-component__wrap">
                                <a href="javascript:;" onclick="liveCommentOffBtn();" id="hideComment" data-mfb-label="Comments Allowed" class="mfb-component__button--child">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 20 20"><g><path fill="#fff" d="M6.5 2a2.5 2.5 0 0 0-2.458 2.042A2.5 2.5 0 0 0 2 6.5v7A2.5 2.5 0 0 0 4.5 16H5v1.028a1 1 0 0 0 1.581.814L9.161 16h.046a5.48 5.48 0 0 1-.185-1H8.84L6 17.028V15H4.5A1.5 1.5 0 0 1 3 13.5v-7A1.5 1.5 0 0 1 4.5 5h9A1.5 1.5 0 0 1 15 6.5v2.522c.343.031.678.094 1 .185V6.5A2.5 2.5 0 0 0 13.5 4H5.085A1.5 1.5 0 0 1 6.5 3h8A2.5 2.5 0 0 1 17 5.5v4.1c.358.183.693.404 1 .657V5.5A3.5 3.5 0 0 0 14.5 2h-8zM19 14.5a4.5 4.5 0 1 1-9 0a4.5 4.5 0 0 1 9 0zm-2.146-1.854a.5.5 0 0 0-.708 0L13.5 15.293l-.646-.647a.5.5 0 0 0-.708.708l1 1a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0 0-.708z" /></g></svg>
                                    
                                    <!-- <img src="{{ asset('public/img/comment.png') }}" style="width: 23px;"> -->
                                </a> 

                                <a href="javascript:;" onclick="liveCommentOnBtn();" id="showComment" data-mfb-label="Comments Blocked" class="mfb-component__button--child" style="display: none;">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><g><path fill="#fff" d="M8.25 2a3.25 3.25 0 0 0-3.241 3.007c.08-.005.16-.007.241-.007h9.5A4.25 4.25 0 0 1 19 9.25v6.5c0 .08-.002.161-.007.241A3.25 3.25 0 0 0 22 12.75v-6A4.75 4.75 0 0 0 17.25 2h-9z" /><path fill="#fff" d="M17.99 16a3.25 3.25 0 0 1-3.24 3h-4.083L7 21.75c-.824.618-2 .03-2-1v-1.76a3.25 3.25 0 0 1-3-3.24v-6.5A3.25 3.25 0 0 1 5.25 6h9.5A3.25 3.25 0 0 1 18 9.25v6.5c0 .084-.003.168-.01.25z" /></g></svg>
                            ...
                            <li class="mfb-component__wrap">
                                <a href="javascript:;" onclick="liveAudioBtn();" id="liveAudioBtn" data-mfb-label="Audio" class="mfb-component__button--child"> 
                            ...
                            <li class="mfb-component__wrap">
                                <a href="javascript:;" onclick="liveVideoBtn();" id="liveVideoBtn" data-mfb-label="Video" class="mfb-component__button--child"> 
                                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><g class="icon-tabler" fill="none" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path fill="none" d="M15 10l4.553-2.276A1 1 0 0 1 21 8.618v6.764a1 1 0 0 1-1.447.894L15 14v-4z"/><rect x="3" y="6" width="12" height="12" rx="2"/></g></svg>
                                    <!-- <img src="{{ asset('public/img/pause.png') }}" style="width: 23px;"/> -->
                                </a>  
                            </li>

                            <li class="mfb-component__wrap share-screen-control">
                                <a href="javascript:;" onclick="screenShare();" id="liveScreenShareBtn" data-mfb-label="Start Sharing Screen" class="mfb-component__button--child">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><g class="icon-tabler" fill="none" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="7" y="3" width="14" height="14" rx="2"/><path d="M17 17v2a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V9a2 2 0 0 1 2-2h2"/></g></svg>
                                    <!-- <i class="fa fa-desktop"></i> -->
                                </a>
                            
                                <a href="javascript:;" onclick="screenShareHide();" id="liveScreenShareHideBtn" data-mfb-label="Stop Sharing Screen" style="display:none;" class="mfb-component__button--child">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><g class="icon-tabler" fill="#fff" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="7" y="3" width="14" height="14" rx="2"/><path  d="M17 17v2a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V9a2 2 0 0 1 2-2h2"/></g></svg>
                                    <!-- <i class="fa fa-desktop"></i> -->
                                </a>
                            </li>

                            <li class="mfb-component__wrap switch-camera-control">
                                <a href="javascript:;" onclick="liveFrontCameraBtn(this.getAttribute('data-camid'), this.getAttribute('data-camlabel'));" id="liveFrontCameraBtn" data-mfb-label=" Rear Camera" style="display:none;" data-camid="" data-camlabel="" class="mfb-component__button--child">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 512 512">
                                                    <path d="M432 144h-59c-3 0-6.72-1.94-9.62-5l-25.94-40.94a15.52 15.52 0 0 0-1.37-1.85C327.11 85.76 315 80 302 80h-92c-13 0-25.11 5.76-34.07 16.21a15.52 15.52 0 0 0-1.37 1.85l-25.94 41c-2.22 2.42-5.34 5-8.62 5v-8a16 16 0 0 0-16-16h-24a16 16 0 0 0-16 16v8h-4a48.05 48.05 0 0 0-48 48V384a48.05 48.05 0 0 0 48 48h352a48.05 48.05 0 0 0 48-48V192a48.05 48.05 0 0 0-48-48zM316.84 346.3a96.06 96.06 0 0 1-155.66-59.18a16 16 0 0 1-16.49-26.43l20-20a16 16 0 0 1 22.62 0l20 20A16 16 0 0 1 196 288a17.31 17.31 0 0 1-2-.14a64.07 64.07 0 0 0 102.66 33.63a16 16 0 1 1 20.21 24.81zm50.47-63l-20 20a16 16 0 0 1-22.62 0l-20-20a16 16 0 0 1 13.09-27.2A64 64 0 0 0 215 222.64A16 16 0 1 1 194.61 198a96 96 0 0 1 156 59a16 16 0 0 1 16.72 26.35z" fill="#fff"></path>
                                                    </svg>
                                    <!-- <img src="{{ asset('public/img/camera.png') }}" style="width: 23px;"/> -->
                                </a> 
                                <a href="javascript:;" onclick="liveBackCameraBtn(this.getAttribute('data-camid'), this.getAttribute('data-camlabel'));" id="liveBackCameraBtn" data-mfb-label=" Front Camera" data-camid="" data-camlabel="" class="mfb-component__button--child">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 512 512">
                                                    <path d="M350.54 148.68l-26.62-42.06C318.31 100.08 310.62 96 302 96h-92c-8.62 0-16.31 4.08-21.92 10.62l-26.62 42.06C155.85 155.23 148.62 160 140 160H80a32 32 0 0 0-32 32v192a32 32 0 0 0 32 32h352a32 32 0 0 0 32-32V192a32 32 0 0 0-32-32h-59c-8.65 0-16.85-4.77-22.46-11.32z" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="32"></path>
                                                    <path fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="32" d="M124 158v-22h-24v22"></path>
                                                    <path d="M335.76 285.22v-13.31a80 80 0 0 0-131-61.6M176 258.78v13.31a80 80 0 0 0 130.73 61.8" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="32"></path>
                                                    <path fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="32" d="M196 272l-20-20l-20 20"></path>
                                                    <path fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="32" d="M356 272l-20 20l-20-20"></path>
                                                    </svg>
                                    <!-- <img src="{{ asset('public/img/camera.png') }}" style="width: 23px;"/> -->
                                </a>
                            </li>
                            ...
                            <li class="mfb-component__wrap">
                                <a href="javascript:;" onclick="liveLeaveBtn();" id="leaveHost"  data-mfb-label="Leave" class="mfb-component__button--child" style="background-color: #f00;"> 
        ...
        <!--                        <img src="https://webmobdemo.xyz/sponzydev/sponzy/public/uploads/avatar/5da8273e-41616952448bwjv1ivj8q.png">-->
                                ...
                                <button id="cohost-remove" type="button" class="btn btn-primary btn-sm cohost-remove" data-cohostname="" style="display:none;"><h4 >Remove</h4></button>
<!-- id="leave" -->
                            </div>
                        </a>
                    </li>
