          ...
          <div class="row form-group mb-0">
            <div class="col-md-6">
              ...
              <div class="col-md-6">
                ...
                <select name="language" class="form-control custom-select browser-default">
              ...
              <div class="row form-group mb-0">
                  <div class="col-md-6">
                      <div class="input-group">
                        ...
                        <input class="form-control" id="birthdate" name="birthdate" placeholder="{{trans('general.birthdate')}} *"  value="{{auth()->user()->birthdate}}" autocomplete="off" type="text">
                      </div>
                    ...
                    <div class="col-md-6">
                      ...
                      <select required name="gender" class="form-control custom-select browser-default">
        ...
        <div class="row form-group mb-0">
            <div class="col-md-6">
              ...
              <div class="col-md-6" id="billing">
                ...
                <select required name="categories_id" class="form-control custom-select browser-default" >
            ...
            @endif
              ...
              <div class="row form-group mb-0">
                ...
                <div class="col-md-6">
                  ...
                  <select name="countries_id" class="form-control custom-select browser-default">
